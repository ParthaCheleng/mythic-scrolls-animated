          ...
          <div className="space-y-8">
            ...
            <div className="scroll-fade-in space-y-6">
              ...
              <div className="bg-card/50 p-6 rounded-lg border border-border/50 backdrop-blur-sm">
                <h3 className="fantasy-title text-2xl font-semibold text-accent mb-4">
                  The Fallen Prophecy
                </h3>
                <p className="text-muted-foreground italic">
                  "When darkness swallows the last ray of hope, the chosen shall rise 
                  from shadow's embrace, bearing golden flame to illuminate the path 
                  of destiny."
                </p>
              </div>
            </div>
